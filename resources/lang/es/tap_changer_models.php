...
return [
    'singular'      => 'Modelo de conmutador',
    'plural'        => 'Modelos de conmutador',
    'record'        => 'modelo de conmutador',
    'records'       => 'modelos de conmutador',
    'new'           => 'Crear modelo de conmutador',
    'id'            => 'N°',

    'index_title'    => 'Modelos de conmutador',
    'index_subtitle' => 'Catalogo de modelos de conmutador.',
    'create_title'   => 'Crear modelo de conmutador',
    'create_subtitle'=> 'Completa los datos para crear un nuevo modelo de conmutador.',
    'edit_title'     => 'Editar modelo de conmutador',
    'delete_title'   => 'Eliminar modelo de conmutador',
    'show_title'     => 'Modelo de conmutador — Información',
    'trash_title'    => 'Papelera de modelos de conmutador',
    'form_create_hint' => 'Completa los datos para crear un nuevo modelo de conmutador.',
    'empty_hint'      => 'Crea el primer modelo de conmutador o importa un lote desde Excel para empezar.',
    'name_placeholder' => 'Ej: VACUTAP VV, OILTAP M, UZ',

    'name'      => 'Nombre',
    'name_help' => 'Modelo del conmutador (ej: VACUTAP VV, OILTAP M).',
    'code'      => 'Código',
    'code_help' => 'Codigo o identificador interno (opcional).',
    'sort_order' => 'Orden',
    'is_active' => 'Estado',
    'is_active_help' => 'Si está inactivo, el modelo de conmutador no aparecerá en los selectores de otros módulos.',
    'filter_name' => 'Nombre',
    ...
    'created' => 'Modelo de conmutador creado.',
    'saved'   => 'Modelo de conmutador actualizado.',
    'deleted' => 'Modelo de conmutador eliminado.',
    ...
    // Export
    'export_filename'           => 'exportacion_modelos_conmutador',
    'import_template_filename'  => 'plantilla-modelos-conmutador.xlsx',
    'export_title'              => 'Reporte de Modelos de Conmutador',
    ...
    'name_unique'              => 'Este modelo de conmutador ya existe.',
    'code_unique'              => 'Ya existe un modelo de conmutador con este código.',
    ...
    // Edit All
    'edit_all_title'    => 'Modelos de conmutador — Editar Todo',
    'edit_all_subtitle' => 'Edita nombre y estado de muchos modelos de conmutador a la vez. Click "Guardar todo" para confirmar, "Cancelar" para descartar.',
    ...
    'edit_all_no_results' => 'No hay modelos de conmutador que coincidan con el filtro.',
    ...
    // Onboarding tour
    'tour' => [
        'step1_title' => 'Bienvenido a Modelos de conmutador',
        'step1_body'  => 'Este es el catálogo de modelos de conmutador. Te mostramos los puntos clave en menos de 1 minuto.',
        'step2_title' => 'Filtros',

...
return [
    'singular'      => 'Tipo de transformador',
    'plural'        => 'Tipos de transformador',
    'record'        => 'tipo de transformador',
    'records'       => 'tipos de transformador',
    'new'           => 'Crear tipo de transformador',
    'id'            => 'N°',

    'index_title'    => 'Tipos de transformador',
    'index_subtitle' => 'Catálogo global de tipos de transformador usados en el diagnóstico.',
    'create_title'   => 'Crear tipo de transformador',
    'create_subtitle'=> 'Completa los datos para crear un nuevo tipo de transformador.',
    'edit_title'     => 'Editar tipo de transformador',
    'delete_title'   => 'Eliminar tipo de transformador',
    'show_title'     => 'Tipo de transformador — Información',
    'trash_title'    => 'Papelera de tipos de transformador',
    'form_create_hint' => 'Completa los datos para crear un nuevo tipo de transformador.',
    'empty_hint'      => 'Crea el primer tipo de transformador o importa un lote desde Excel para empezar.',
    'name_placeholder' => 'Ej: Potencia, Distribución, Horno',

    'name'      => 'Nombre',
    'name_help' => 'Nombre del tipo de transformador (ej: Potencia, Distribución, Horno).',
    'code'      => 'Código',
    'code_help' => 'Identificador técnico interno (ej: potencia, distribucion, horno).',
    'shape'      => 'Figura',
    'shape_help' => 'Silueta con la que se dibuja este tipo en la ficha del transformador.',
    'shape_tank' => 'Tanque (potencia)',
    'shape_pole' => 'Poste (distribución)',
    'shape_dry'  => 'Seco / encapsulado',
    'shape_preview' => 'Vista previa',
    'sort_order' => 'Orden',
    'is_active' => 'Estado',
    'is_active_help' => 'Si está inactivo, el tipo de transformador no aparecerá en los selectores de otros módulos.',
    'filter_name' => 'Nombre',
    ...
    'created' => 'Tipo de transformador creado.',
    'saved'   => 'Tipo de transformador actualizado.',
    'deleted' => 'Tipo de transformador eliminado.',
    ...
    // Export
    'export_filename'           => 'exportacion_tipos_transformador',
    'import_template_filename'  => 'plantilla-tipos-transformador.xlsx',
    'export_title'              => 'Reporte de Tipos de Transformador',
    ...
    'name_unique'              => 'Este tipo de transformador ya existe.',
    'code_unique'              => 'Ya existe un tipo de transformador con este código.',
    ...
    // Edit All
    'edit_all_title'    => 'Tipos de transformador — Editar Todo',
    'edit_all_subtitle' => 'Edita nombre y estado de muchos tipos de transformador a la vez. Click "Guardar todo" para confirmar, "Cancelar" para descartar.',
    ...
    'edit_all_no_results' => 'No hay tipos de transformador que coincidan con el filtro.',
    ...
    // Onboarding tour
    'tour' => [
        'step1_title' => 'Bienvenido a Tipos de transformador',
        'step1_body'  => 'Este es el catálogo de tipos de transformador. Te mostramos los puntos clave en menos de 1 minuto.',
        'step2_title' => 'Filtros',

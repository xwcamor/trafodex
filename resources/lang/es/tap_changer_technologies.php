...
return [
    'singular'      => 'Tecnologia de conmutador',
    'plural'        => 'Tecnologias de conmutador',
    'record'        => 'tecnologia de conmutador',
    'records'       => 'tecnologias de conmutador',
    'new'           => 'Crear tecnologia de conmutador',
    'id'            => 'N°',

    'index_title'    => 'Tecnologias de conmutador',
    'index_subtitle' => 'Catalogo de tecnologias de conmutador (solo OLTC).',
    'create_title'   => 'Crear tecnologia de conmutador',
    'create_subtitle'=> 'Completa los datos para crear un nuevo tecnologia de conmutador.',
    'edit_title'     => 'Editar tecnologia de conmutador',
    'delete_title'   => 'Eliminar tecnologia de conmutador',
    'show_title'     => 'Tecnologia de conmutador — Información',
    'trash_title'    => 'Papelera de tecnologias de conmutador',
    'form_create_hint' => 'Completa los datos para crear un nuevo tecnologia de conmutador.',
    'empty_hint'      => 'Crea el primer tecnologia de conmutador o importa un lote desde Excel para empezar.',
    'name_placeholder' => 'Ej: Vacio, Resistiva, Reactancia',

    'name'      => 'Nombre',
    'name_help' => 'Tecnologia de conmutacion (ej: vacio, resistiva, reactancia).',
    'code'      => 'Código',
    'code_help' => 'Codigo o identificador interno (opcional).',
    'sort_order' => 'Orden',
    'is_active' => 'Estado',
    'is_active_help' => 'Si está inactivo, el tecnologia de conmutador no aparecerá en los selectores de otros módulos.',
    'filter_name' => 'Nombre',
    ...
    'created' => 'Tecnologia de conmutador creado.',
    'saved'   => 'Tecnologia de conmutador actualizado.',
    'deleted' => 'Tecnologia de conmutador eliminado.',
    ...
    // Export
    'export_filename'           => 'exportacion_tecnologias_conmutador',
    'import_template_filename'  => 'plantilla-tecnologias-conmutador.xlsx',
    'export_title'              => 'Reporte de Tecnologias de Conmutador',
    ...
    'name_unique'              => 'Este tecnologia de conmutador ya existe.',
    'code_unique'              => 'Ya existe un tecnologia de conmutador con este código.',
    ...
    // Edit All
    'edit_all_title'    => 'Tecnologias de conmutador — Editar Todo',
    'edit_all_subtitle' => 'Edita nombre y estado de muchos tecnologias de conmutador a la vez. Click "Guardar todo" para confirmar, "Cancelar" para descartar.',
    ...
    'edit_all_no_results' => 'No hay tecnologias de conmutador que coincidan con el filtro.',
    ...
    // Onboarding tour
    'tour' => [
        'step1_title' => 'Bienvenido a Tecnologias de conmutador',
        'step1_body'  => 'Este es el catálogo de tecnologias de conmutador. Te mostramos los puntos clave en menos de 1 minuto.',
        'step2_title' => 'Filtros',

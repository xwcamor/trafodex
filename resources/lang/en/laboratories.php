...
return [
    ...
    'plural'        => 'Laboratories',
    'record'        => 'laboratory',
    'records'       => 'laboratories',
    'new'           => 'Create laboratory',
    'id'            => 'No.',

    'index_title'    => 'Laboratories',
    'index_subtitle' => 'Catalog of laboratories that run your transformers analyses.',
    'create_title'   => 'Create laboratory',
    'create_subtitle'=> 'Fill in the data to create a new laboratory.',
    'edit_title'     => 'Edit laboratory',
    'delete_title'   => 'Delete laboratory',
    'show_title'     => 'Laboratory — Details',
    'trash_title'    => 'Laboratories trash',
    'form_create_hint' => 'Fill in the data to create a new laboratory.',
    'empty_hint'      => 'Create your first laboratory or import a batch from Excel.',
    'name_placeholder' => 'E.g.: Internal lab, SGS, Doble Engineering',

    'name'      => 'Name',
    'name_help' => 'Name of the laboratory that issues the test report.',
    'code'      => 'Code',
    'code_help' => 'Laboratory identifier or accreditation (optional).',
    'sort_order' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the laboratory will not appear in the sample selectors.',
    'filter_name' => 'Name',
    ...
    'export_filename'           => 'laboratories_export',
    'import_template_filename'  => 'laboratories-template.xlsx',
    'export_title'              => 'Laboratories Report',
    ...
    'name_unique'              => 'This laboratory already exists.',
    'code_unique'              => 'A laboratory with this code already exists.',
    ...
    'edit_all_title'    => 'Laboratories — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple laboratories at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No laboratories match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to Laboratories',
        'step1_body'  => 'This is the laboratories catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',

...
return [
    'singular'      => 'Tap changer type',
    'plural'        => 'Tap changer types',
    'record'        => 'tap changer type',
    'records'       => 'tap changer types',
    'new'           => 'Create tap changer type',
    'id'            => 'No.',

    'index_title'    => 'Tap changer types',
    'index_subtitle' => 'Global catalog of tap changer types used in diagnostics.',
    'create_title'   => 'Create tap changer type',
    'create_subtitle'=> 'Fill in the data to create a new tap changer type.',
    'edit_title'     => 'Edit tap changer type',
    'delete_title'   => 'Delete tap changer type',
    'show_title'     => 'Tap changer type — Details',
    'trash_title'    => 'Tap changer types trash',
    'form_create_hint' => 'Fill in the data to create a new tap changer type.',
    'empty_hint'      => 'Create your first tap changer type or import a batch from Excel.',
    'name_placeholder' => 'E.g.: De-energized (DETC), On-load (OLTC)',

    'name'      => 'Name',
    'name_help' => 'Tap changer type name (e.g. De-energized (DETC), On-load (OLTC)).',
    'code'      => 'Code',
    'code_help' => 'Internal technical identifier (e.g. mineral, silicone, vegetable_soy).',
    'sort_order' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the tap changer type will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'created' => 'Tap changer type created.',
    'saved'   => 'Tap changer type updated.',
    'deleted' => 'Tap changer type deleted.',
    ...
    'export_filename'           => 'tap_changer_types_export',
    'import_template_filename'  => 'tap-changer-types-template.xlsx',
    'export_title'              => 'Tap Changer Types Report',
    ...
    'name_unique'              => 'This tap changer type already exists.',
    'code_unique'              => 'An tap changer type with this code already exists.',
    ...
    'edit_all_title'    => 'Tap changer types — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple tap changer types at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No tap changer types match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to Tap changer types',
        'step1_body'  => 'This is the tap changer types catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',

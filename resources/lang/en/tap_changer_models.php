...
return [
    'singular'      => 'Tap changer model',
    'plural'        => 'Tap changer models',
    'record'        => 'tap changer model',
    'records'       => 'tap changer models',
    'new'           => 'Create tap changer model',
    'id'            => 'No.',

    'index_title'    => 'Tap changer models',
    'index_subtitle' => 'Catalog of tap changer models.',
    'create_title'   => 'Create tap changer model',
    'create_subtitle'=> 'Fill in the data to create a new tap changer model.',
    'edit_title'     => 'Edit tap changer model',
    'delete_title'   => 'Delete tap changer model',
    'show_title'     => 'Tap changer model — Details',
    'trash_title'    => 'Tap changer models trash',
    'form_create_hint' => 'Fill in the data to create a new tap changer model.',
    'empty_hint'      => 'Create your first tap changer model or import a batch from Excel.',
    'name_placeholder' => 'E.g.: VACUTAP VV, OILTAP M, UZ',

    'name'      => 'Name',
    'name_help' => 'Tap changer model (e.g. VACUTAP VV, OILTAP M).',
    'code'      => 'Code',
    'code_help' => 'Internal code or identifier (optional).',
    'sort_order' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the tap changer model will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'created' => 'Tap changer model created.',
    'saved'   => 'Tap changer model updated.',
    'deleted' => 'Tap changer model deleted.',
    ...
    'export_filename'           => 'tap_changer_models_export',
    'import_template_filename'  => 'tap-changer-types-template.xlsx',
    'export_title'              => 'Tap Changer Models Report',
    ...
    'name_unique'              => 'This tap changer model already exists.',
    'code_unique'              => 'An tap changer model with this code already exists.',
    ...
    'edit_all_title'    => 'Tap changer models — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple tap changer models at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No tap changer models match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to Tap changer models',
        'step1_body'  => 'This is the tap changer models catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',

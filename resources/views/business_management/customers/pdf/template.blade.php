                        ...
                        @foreach ($columns as $col)
                            <td>
                                @switch($col)
                                    ...
                                    @case('address')   {{ $customer->address ?? '' }} @break
                                    @case('locations_count')    {{ (int) ($customer->locations_count ?? 0) }} @break
                                    @case('areas_count')        {{ (int) ($customer->areas_count ?? 0) }} @break
                                    @case('substations_count')  {{ (int) ($customer->substations_count ?? 0) }} @break
                                    @case('transformers_count') {{ (int) ($customer->transformers_count ?? 0) }} @break
                                    @case('is_active')

...
const submit = () => {
    form.delete(route('business_management.tap_changer_technologies.deleteSave', props.tapChangerTechnology.slug), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head :title="$t('global.delete') + ' — ' + $t('tap_changer_technologies.singular')" />

    <DeletePage
        :back-href="route('business_management.tap_changer_technologies.index')"
        :title="$t('global.delete') + ' ' + $t('tap_changer_technologies.record')"
        :subtitle="tapChangerTechnology.name"
    ...
    >
        ...
        <template #summary>
            <DeleteSummaryRow :label="$t('tap_changer_technologies.name')">{{ tapChangerTechnology.name }}</DeleteSummaryRow>
            <DeleteSummaryRow v-if="tapChangerTechnology.code" :label="$t('tap_changer_technologies.code')">
                <code>{{ tapChangerTechnology.code }}</code>
            </DeleteSummaryRow>
            <DeleteSummaryRow :label="$t('tap_changer_technologies.is_active')">
                <Tag :color="tapChangerTechnology.is_active ? 'success' : 'error'" :bordered="false">

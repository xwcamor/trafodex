 ...
 */
export const transformerTypesTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('transformer_types.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('transformer_types.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },

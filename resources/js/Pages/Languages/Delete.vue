...
<template>
    ...
    >
        ...
        <template #summary>
            <DeleteSummaryRow :label="$t('languages.name')">{{ language.name }}</DeleteSummaryRow>
            <DeleteSummaryRow :label="$t('languages.iso_code')">
                <code>{{ language.iso_code }}</code>
            </DeleteSummaryRow>
            <DeleteSummaryRow :label="$t('languages.is_active')">

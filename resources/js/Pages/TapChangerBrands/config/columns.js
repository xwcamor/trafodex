...
/**
 * Columnas de la tabla principal de TapChangerBrands.
 *
 ...
 */
export const tapChangerBrandsTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    { title: '★',                      dataIndex: 'is_favorite', key: 'favorite',   width: 48,  alwaysVisible: true, mobile: { role: 'pin' } },
    { title: t('tap_changer_brands.name'),     dataIndex: 'name',        key: 'name',       sorter: (a, b) => a.name.localeCompare(b.name), alwaysVisible: true, mobile: { role: 'title' } },
    ...(isSuper ? [
    ...
    { title: t('tap_changer_brands.code'),     dataIndex: 'code',        key: 'code',       sorter: true, width: 160, mobile: { role: 'meta', icon: TagOutlined }, defaultHidden: true },
    { title: t('tap_changer_brands.is_active'), dataIndex: 'is_active',   key: 'status', sorter: (a, b) => Number(a.is_active) - Number(b.is_active),     width: 110, align: 'center', mobile: { role: 'status' } },

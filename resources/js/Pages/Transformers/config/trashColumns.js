 ...
 */
export const transformersTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('transformers.serial'),          dataIndex: 'serial',              key: 'serial',      ellipsis: true, mobile: { role: 'title' } },
    { title: t('transformers.tag'),             dataIndex: 'tag',                 key: 'tag',         width: 140, mobile: { role: 'meta' } },

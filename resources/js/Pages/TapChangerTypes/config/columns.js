...
/**
 * Columnas de la tabla principal de TapChangerTypes.
 *
 ...
 */
export const tapChangerTypesTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    { title: '★',                      dataIndex: 'is_favorite', key: 'favorite',   width: 48,  alwaysVisible: true, mobile: { role: 'pin' } },
    { title: t('tap_changer_types.name'),     dataIndex: 'name',        key: 'name',       sorter: (a, b) => a.name.localeCompare(b.name), alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('tap_changer_types.code'),     dataIndex: 'code',        key: 'code',       sorter: true, width: 160, mobile: { role: 'meta', icon: TagOutlined }, defaultHidden: true },
    { title: t('tap_changer_types.is_active'), dataIndex: 'is_active',   key: 'status',     sorter: true, width: 110, align: 'center', mobile: { role: 'status' } },

 ...
 */
export const tapChangerTypesTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('tap_changer_types.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('tap_changer_types.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },

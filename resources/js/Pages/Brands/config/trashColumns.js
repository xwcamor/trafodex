 ...
 */
export const brandsTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('brands.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('brands.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },

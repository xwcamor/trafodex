 ...
 */
export const customersTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('customers.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('customers.cod'),             dataIndex: 'cod',                 key: 'cod',         width: 140, mobile: { role: 'meta' } },

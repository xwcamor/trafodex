<script setup>
/**
 * Tabla editable in-line del flujo Edit-All de Brands. Recibe `draft` por
    ...
    <table v-if="draft.length > 0" class="edit-table">
        <thead>
            <tr>
                ...
                <th class="col-name">{{ $t('brands.table_headers.editable_name') }}</th>
                <th class="col-cod">{{ $t('brands.code') }}</th>
                <th class="col-status">{{ $t('brands.table_headers.editable_status') }}</th>
            </tr>
        </thead>
        <tbody>
            <tr

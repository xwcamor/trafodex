...
const onMenu = ({ key }) => {
    if (key === 'view')       router.visit(route('system_management.system_modules.show', props.record.slug));
    else if (key === 'edit')  router.visit(route('system_management.system_modules.edit', props.record.slug));

...
const onMenu = ({ key }) => {
    if (key === 'view')           router.visit(route('system_management.countries.show', props.record.slug));
    else if (key === 'edit')      router.visit(route('system_management.countries.edit', props.record.slug));

...
defineProps({
    ...
    tourTarget: { type: Boolean, default: false },
});
...
<template>
    <button
        ...
        :data-tour="tourTarget ? 'favorites' : null"
    >
...
/* Color del icono — directo al SVG con !important. El SVG de ant-design
   tiene `fill="currentColor"` en el atributo, pero por scoping de Vue +
   reset.css el currentColor no siempre hereda. Setear `fill` explícito
   en el path es la forma definitiva. Tokens vía var() para que respete
   dark theme. */

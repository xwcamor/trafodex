...
const onMenu = ({ key }) => {
    if (key === 'view')           router.visit(route('system_management.languages.show', props.record.slug));
    else if (key === 'edit')      router.visit(route('system_management.languages.edit', props.record.slug));

...
const onMenu = ({ key }) => {
    if (key === 'view')           router.visit(route('system_management.locales.show', props.record.slug));
    else if (key === 'edit')      router.visit(route('system_management.locales.edit', props.record.slug));

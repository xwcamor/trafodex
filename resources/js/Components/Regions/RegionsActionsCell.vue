...
const onMenu = ({ key }) => {
    if (key === 'view')            router.visit(route('system_management.regions.show', props.record.slug));
...
<template>
    <!-- Compact: kebab unico (card-view denso). Mismas acciones/condiciones que
         los bloques desktop/mobile. -->

...
/*
|--------------------------------------------------------------------------
| Countries module — tunable knobs
|--------------------------------------------------------------------------
|
...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('COUNTRIES_EXPORT_LIMIT_CSV',   0),     // 0 = sin límite (streaming)
        'excel' => env('COUNTRIES_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('COUNTRIES_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('COUNTRIES_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('COUNTRIES_EXPORT_MEMORY', '512M'),
];

...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('TENANTS_EXPORT_LIMIT_CSV',   0),     // 0 = sin límite (streaming)
        'excel' => env('TENANTS_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('TENANTS_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('TENANTS_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('TENANTS_EXPORT_MEMORY', '512M'),
];

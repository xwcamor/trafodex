...
/**
 * TapChangerTechnology — catalogo per-tenant del conmutador.
 ...
 * usa BelongsToTenantOrGlobal. Mantiene SoftDeletes + Auditable + HasFavorites.
 */
class TapChangerTechnology extends Model
{
    use HasFactory, SoftDeletes, Auditable, BelongsToTenantOrGlobal, HasFavorites, \App\Traits\Lockable;

    protected string $auditModule = 'tap_changer_technologies';
    ...
    /** Transformadores con este registro del conmutador (FK tap_changer_technology_id). */
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla tap_changer_technologies.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('tap_changer_technologies.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('tap_changer_technologies.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('tap_changer_technologies.is_active'), 'type' => 'boolean', 'operators' => ['=']],

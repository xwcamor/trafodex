...
/**
 * Laboratory — catálogo de laboratorios que realizan los analisis (per-tenant).
...
class Laboratory extends Model
{
    ...
    protected string $auditModule = 'laboratories';
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla laboratories.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('laboratories.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('laboratories.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('laboratories.is_active'), 'type' => 'boolean', 'operators' => ['=']],

...
/**
 * TapChangerBrand — catalogo per-tenant del conmutador.
...
class TapChangerBrand extends Model
{
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla tap_changer_brands.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('tap_changer_brands.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('tap_changer_brands.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('tap_changer_brands.is_active'), 'type' => 'boolean', 'operators' => ['=']],

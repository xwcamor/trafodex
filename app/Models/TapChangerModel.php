...
/**
 * TapChangerModel — catalogo per-tenant del conmutador.
...
class TapChangerModel extends Model
{
    ...
    /** Transformadores con este registro del conmutador (FK tap_changer_model_id). */
    ...
    /**
     * scopeFilter — mismo patrón que Customer, sobre la tabla tap_changer_models.
    ...
    {
        return [
            ['key' => 'name',       'label' => __('tap_changer_models.name'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'code',       'label' => __('tap_changer_models.code'),     'type' => 'string',  'operators' => ['=', '!=', 'contains']],
            ['key' => 'is_active',  'label' => __('tap_changer_models.is_active'), 'type' => 'boolean', 'operators' => ['=']],

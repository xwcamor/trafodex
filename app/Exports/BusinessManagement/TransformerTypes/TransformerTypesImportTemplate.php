...
/**
 * Plantilla XLSX descargable para imports de transformer_types.
 *
 * Columnas:
 ...
 */
class TransformerTypesImportTemplate implements FromArray, WithEvents
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $commentCode->getText()->createTextRun(
                    __('transformer_types.code_help')
                );

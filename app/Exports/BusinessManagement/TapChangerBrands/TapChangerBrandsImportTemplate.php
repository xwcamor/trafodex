...
/**
 * Plantilla XLSX descargable para imports de tap_changer_brands.
 *
 * Columnas:
 ...
 */
class TapChangerBrandsImportTemplate implements FromArray, WithEvents
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $commentCode->getText()->createTextRun(
                    __('tap_changer_brands.code_help')
                );

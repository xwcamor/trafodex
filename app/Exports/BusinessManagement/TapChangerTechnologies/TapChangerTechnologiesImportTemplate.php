...
/**
 * Plantilla XLSX descargable para imports de tap_changer_technologies.
 *
 * Columnas:
 ...
 */
class TapChangerTechnologiesImportTemplate implements FromArray, WithEvents
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $commentCode->getText()->createTextRun(
                    __('tap_changer_technologies.code_help')
                );

...
/**
 * Plantilla XLSX descargable para imports de oil_types.
 *
 * Columnas:
 ...
 * como datos — los tips van en cell comments.
 */
class OilTypesImportTemplate implements FromArray, WithEvents
{

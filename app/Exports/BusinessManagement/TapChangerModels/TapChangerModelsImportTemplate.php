...
/**
 * Plantilla XLSX descargable para imports de tap_changer_models.
 *
 * Columnas:
 ...
 */
class TapChangerModelsImportTemplate implements FromArray, WithEvents
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $commentCode->getText()->createTextRun(
                    __('tap_changer_models.code_help')
                );

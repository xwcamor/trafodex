...
namespace App\Imports\SystemManagement\Settings;
...
/**
 * Imports Settings from .xlsx/.csv.
 *
 ...
 */
class SettingsImport implements ToCollection, WithHeadingRow
{
    ...
    protected function findExistingByNameInsensitive(string $name): ?Setting
    {

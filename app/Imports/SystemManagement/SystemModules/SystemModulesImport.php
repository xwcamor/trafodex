...
namespace App\Imports\SystemManagement\SystemModules;
...
/**
 * Imports SystemModules from .xlsx/.csv.
 *
 ...
 */
class SystemModulesImport implements ToCollection, WithHeadingRow
{
    ...
    public function __construct(
        ...
        protected ?SystemModuleService $service = null,
    ) {
        $this->service ??= app(SystemModuleService::class);
    }
    ...
    protected function findExistingByNameInsensitive(string $name): ?SystemModule
    {

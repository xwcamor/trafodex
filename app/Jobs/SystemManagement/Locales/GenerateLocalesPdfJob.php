...
class GenerateLocalesPdfJob extends BaseLocaleExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $columns        = $this->options['columns']                 ?? ['id', 'name', 'code', 'language', 'is_active', 'created_at', 'creator'];
        ...
        $pdf = Pdf::loadView('system_management.locales.pdf.template', [
            'locales'        => $locales,
            'columns'        => $columns,
            'title'          => $title,

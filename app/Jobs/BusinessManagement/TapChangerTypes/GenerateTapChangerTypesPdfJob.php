...
class GenerateTapChangerTypesPdfJob extends BaseTapChangerTypeExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $pdf = Pdf::loadView('business_management.tap_changer_types.pdf.template', [
            'tap_changer_types'      => $tapChangerTypes,
            'columns'        => $columns,
            'title'          => $title,

...
class GenerateTapChangerTechnologiesPdfJob extends BaseTapChangerTechnologyExportJob
{
    ...
    protected function executeExport(Download $download): void
    {
        ...
        $pdf = Pdf::loadView('business_management.tap_changer_technologies.pdf.template', [
            'tap_changer_technologies'      => $tapChangerTechnologies,
            'columns'        => $columns,
            'title'          => $title,

...
/**
 * Triple guard del force-delete (patrón Regions):
 *   1. authorize() exige super
 *   2. rules() exige name_confirmation que matchee el nombre del plan
 *   3. rules() exige reason ≥ 10 chars (audit trail)
 *
 * El controller hace defense-in-depth con onlyTrashed + abort_unless.
 */
class ForcePlanDeleteRequest extends FormRequest
{

...
class EditAllUpdateOilTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('oil_types.edit') ?? false;
    }

    public function rules(): array
    {
        // edit_all_max define cuantas filas se pueden tocar en un solo batch.
        $max = (int) config('oil_types.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podÃ­a mandar name:"" y el oilType quedaba sin nombre

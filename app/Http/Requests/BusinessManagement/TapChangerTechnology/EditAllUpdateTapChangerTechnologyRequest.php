...
class EditAllUpdateTapChangerTechnologyRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('tap_changer_technologies.edit') ?? false;
    }

    public function rules(): array
    {
        // edit_all_max define cuantas filas se pueden tocar en un solo batch.
        $max = (int) config('tap_changer_technologies.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podÃ­a mandar name:"" y el tapChangerTechnology quedaba sin nombre

...
class BulkDeleteTransformerTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:transformer_types.delete ya gatea la ruta â€” este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('transformer_types.delete') ?? false;
    }

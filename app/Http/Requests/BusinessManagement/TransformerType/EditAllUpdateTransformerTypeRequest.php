...
class EditAllUpdateTransformerTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $max = (int) config('transformer_types.edit_all_max', 200);
        ...
        return [
            ...
            // un cliente podÃ­a mandar name:"" y el transformerType quedaba sin nombre

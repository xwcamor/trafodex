...
class BulkDeleteTapChangerTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:tap_changer_types.delete ya gatea la ruta â€” este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('tap_changer_types.delete') ?? false;
    }

...
class BulkDeleteTransformerRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:transformers.delete ya gatea la ruta — este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('transformers.delete') ?? false;
    }

...
class BulkDeleteTapChangerModelRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:tap_changer_models.delete ya gatea la ruta â€” este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('tap_changer_models.delete') ?? false;
    }

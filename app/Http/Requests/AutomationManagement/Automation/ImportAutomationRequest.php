...
/**
 * Validacion del upload de imports de Automations. Clon del ImportRequest de
 * Customers — la ruta ya valida role:super|admin + plan_feature:bulk_operations.
 */
class ImportAutomationRequest extends FormRequest
{
